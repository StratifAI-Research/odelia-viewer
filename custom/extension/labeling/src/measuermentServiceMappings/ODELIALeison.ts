...
const ODELIALeison = {
  ...
  toMeasurement: (
    ...
    if (!metadata || !data) {
      console.warn('ODELIALeison tool: Missing metadata or data');
      return null;
    }


    if (annotation.type != "ODELIALeison") {
...
export { ODELIALeison, ODELIA_LABELING_SOURCE_NAME, ODELIA_LABELING_SOURCE_VERSION };
