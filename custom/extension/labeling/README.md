...
OHIF **extension** providing the ODELIA study/lesion labeling UI. It lets a
reader assign structured labels (per patient, per study, and per lesion) to a
study and export/import them as CSV.
