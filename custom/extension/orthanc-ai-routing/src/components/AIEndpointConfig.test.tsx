...
describe('AIEndpointConfig — form validation & add', () => {
  it('reports required-field and URL-format errors', () => {
    ...
    fireEvent.change(screen.getByPlaceholderText('http://ai-server:8042'), { target: { value: 'ftp://nope' } });
  ...
  it('adds a valid endpoint and persists it', () => {
    ...
    fireEvent.change(screen.getByPlaceholderText('http://ai-server:8042'), { target: { value: 'http://gamma:8042' } });
    fireEvent.click(screen.getByText('Add'));
