...
export const makeAIResult = (o: Partial<AIResult> = {}): AIResult => ({ studyInstanceUID: 's1', hasHeatmap: false, classifications: [], ...o });
...
export function installConsoleErrorFilter(
  { silenceLog = false, silenceWarn = false }: { silenceLog?: boolean; silenceWarn?: boolean } = {}
) {
